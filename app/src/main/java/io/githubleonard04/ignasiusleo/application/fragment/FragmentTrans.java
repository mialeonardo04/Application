...
import io.githubleonard04.ignasiusleo.application.model.DataHelper;
...
public class FragmentTrans extends Fragment {
    ...
    protected void showDialog() {
        ...
        View view = getActivity().getLayoutInflater().inflate(io.githubleonard04.ignasiusleo.application.R.layout.dialog_payment, null);
        dialog.setContentView(view);

        TextView tvTotHarga = view.findViewById(io.githubleonard04.ignasiusleo.application.R.id.total_harga);
        final TextView tvKembali = view.findViewById(io.githubleonard04.ignasiusleo.application.R.id.cashback);
        final EditText etBayar = view.findViewById(io.githubleonard04.ignasiusleo.application.R.id.cash);
        Button submitPayment = view.findViewById(io.githubleonard04.ignasiusleo.application.R.id.submit);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(io.githubleonard04.ignasiusleo.application.R.layout.fragment_trans, container, false);
        tl = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.tl1);
        ...
        txtTotal = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.txtTotal);
        txt = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.ceng);
        btn1 = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.btnMinus);
        btn2 = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.btnPlus);
    ...
    public void newRow() {
        ...
        scr4.setText("-");
        scr4.setId(io.githubleonard04.ignasiusleo.application.R.id.btnMinus);
