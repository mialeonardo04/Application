...
public class FragmentPreview extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(io.githubleonard04.ignasiusleo.application.R.layout.fragment_preview, container, false);

        id_stock = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.id_barcode);
        id_barang = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.id_barang);
        nama_barang = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.nama_barang);
        qty = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.jml_barang);
        harga = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.hrg_barang);
        tgl_dtg = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.tgl_dtg);
        tgl_exp = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.tgl_exp);
        save = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.saveEdit);
        ...
        setEdit = v.findViewById(io.githubleonard04.ignasiusleo.application.R.id.setEdit);
